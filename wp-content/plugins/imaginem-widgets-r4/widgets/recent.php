...
?>
	<a class="recent_thumbnail" href="<?php echo $linked_to; ?>" title="<?php the_title();?>">
<?php
} else {
?>
...
if($postformat == "link") {
	$linked_to= get_post_meta(get_the_ID(), MTHEME . '_meta_link', true);
?>
	<a class="recentpost_title" href="<?php echo $linked_to; ?>" title="<?php the_title();?>">
<?php
} else {
?>
	<a class="recentpost_title" href="<?php echo get_permalink() ?>" title="<?php the_title();?>">
<?php
}
if ( get_the_title() ) the_title(); else the_ID(); ?></a>
