 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme kinetika for publication on ThemeForest
...
add_action( 'tgmpa_register', 'mtheme_register_required_plugins' );
 ...
 */
function mtheme_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-widgets-r4.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-fullscreen-post-type.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-portfolio-post-type-r2.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-shortcodes-r7.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-events.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-photo-proofing.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-builder-r2.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-photostories.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'     				=> 'iMaginem Demo Importer', // The plugin name
			'slug'     				=> 'imaginem-demo-importer', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/framework/plugins/imaginem-demo-importer.zip', // The plugin source
	 ...
	 */
	$config = array(
		'id'           => 'mthemelocal',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'strings'      => array(
			...
			/* translators: %s: plugin name. */
			'updating'                        => __( 'Updating Plugin: %s', 'mthemelocal' ),
			...
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'mthemelocal' ),
			/* translators: 1: plugin name. */
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'mthemelocal' ),
			/* translators: 1: plugin name. */
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'mthemelocal' ),
			/* translators: 1: dashboard link. */
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'mthemelocal' ),
			'dismiss'                         => __( 'Dismiss this notice', 'mthemelocal' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'mthemelocal' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'mthemelocal' ),
